...
from vivarium_conic_vitamin_a_supp_gbd2019.constants import data_keys, metadata
from vivarium_conic_vitamin_a_supp_gbd2019.utilities import sanitize_location, delete_if_exists, len_longest_location
from vivarium_conic_vitamin_a_supp_gbd2019.tools.app_logging import add_logging_sink, decode_status
...
def build_single_location_artifact(path: Union[str, Path], location: str, log_to_file: bool = False):
    ...
    from vivarium_conic_vitamin_a_supp_gbd2019.data import builder
